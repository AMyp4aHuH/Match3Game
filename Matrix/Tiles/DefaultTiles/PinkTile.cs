...
namespace Match3Game.MatrixElements.DefaultTiles
{
    ...
    {
        public PinkTile(TileType type) : base()
        {
            Type = type;
            LoadTextures(type);
        }
        ...
        private void LoadTextures(TileType type)
        {
            ...
            Animation idleAnim = new Animation(TextureProvider.PinkTile.Textures.Idle, AnimationConfig.IdlePeriod, true);
            Animation destroyAnim = new Animation(TextureProvider.PinkTile.Textures.Destroy, AnimationConfig.DestroyPeriod);
            Animation selectAnim = new Animation(TextureProvider.PinkTile.Textures.Destroy, AnimationConfig.SelectPeriod, true);
            Animation waitDestroy = new Animation(TextureProvider.PinkTile.Textures.Idle, AnimationConfig.WhaitDestroy);
