...
namespace Match3Game.MatrixElements.DefaultTiles
{
    ...
    {
        public GreenTile(TileType type) : base()
        {
            Type = type;
            LoadTextures(type);
        }
        ...
        private void LoadTextures(TileType type)
        {
            ...
            Animation idleAnim = new Animation(TextureProvider.GreenTile.Textures.Idle, AnimationConfig.IdlePeriod, true);
            Animation destroyAnim = new Animation(TextureProvider.GreenTile.Textures.Destroy, AnimationConfig.DestroyPeriod);
            Animation selectAnim = new Animation(TextureProvider.GreenTile.Textures.Destroy, AnimationConfig.SelectPeriod, true);
            Animation waitDestroy = new Animation(TextureProvider.GreenTile.Textures.Idle, AnimationConfig.WhaitDestroy);
